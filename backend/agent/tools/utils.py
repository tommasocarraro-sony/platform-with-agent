...
def create_lists_for_fuzzy_matching():
    ...
    actors_list = extract_unique_names("./backend/movielens/data/final_ml-100k.csv", "actors_list")
    producers_list = extract_unique_names("./backend/movielens/data/final_ml-100k.csv",
                                          "producers_list")
    directors_list = extract_unique_names("./backend/movielens/data/final_ml-100k.csv",
                                          "directors_list")
    genres_list = extract_unique_names("./backend/movielens/data/final_ml-100k.csv", "genres_list")
    countries_list = extract_unique_names("./backend/movielens/data/final_ml-100k.csv", "country")
